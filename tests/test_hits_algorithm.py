...
class QuickTest(unittest.TestCase):
	...
	def test_benchmark(self):
		...
		list_hits_a = [124, 220, 101, 7, 0, 0, 0, 7, 0, 0, 0, 1, 6, 0, 0, 0, 0, 0, 0, 1, 18, 395, 256, 0, 0, 0, 0, 0, 0, 0, 10, 14, 0, 0, 0, 0, 10, 0, 0, 0, 0, 0, 0, 0, 1, 48, 6, 3, 0, 1, 0, 10, 51, 6, 0, 0, 1, 0, 1, 0, 0, 2, 37, 109, 95, 26, 21, 32, 5, 6, 0, 0, 0, 0, 1, 1, 1, 1]
		...
		for num in range(len(list_hits_a)):
			if num in the_hits:
				print(list_hits_a[num])
			else:
				pass
